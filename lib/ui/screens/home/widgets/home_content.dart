...
import '../../home/widgets/home_history_tile.dart';
...
class HomeContent extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              BlaRidePreferencePicker(
                initRidePreference: vm.selectedRidePreference,
  ...
  Widget _buildHistory(HomeViewModel vm, BuildContext context) {
    ...
    List<RidePreference> history = vm.ridePreferenceHistory.reversed.toList();
    return SizedBox(
